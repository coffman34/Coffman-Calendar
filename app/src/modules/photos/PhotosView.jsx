...
const PhotosView = () => {
    ...
    if (!allPhotos || allPhotos.length === 0) {
        return (
            <Box sx={{ p: 6, textAlign: 'center', height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                <Paper elevation={0} sx={{ p: 4, borderRadius: 4, bgcolor: '#FFFFFF', border: '1px solid rgba(0,0,0,0.05)', boxShadow: '0 4px 12px rgba(0,0,0,0.05)' }}>
    ...
    return (
        <AppCard
            title={
                <Box>
                    <Typography variant="h6" fontWeight="bold">Photo Library</Typography>
