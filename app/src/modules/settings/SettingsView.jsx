            ...
            <Box p={3} maxWidth={1200} mx="auto" height="100%" sx={{ overflow: 'auto' }}>
                <Grid container spacing={3}>
                    ...
                    <Grid size={{ xs: 12, md: 6 }}>
                        <AppCard title="Profiles" gradient="linear-gradient(135deg, #11998e 0%, #38ef7d 100%)" sx={{ bgcolor: '#FFFFFF' }}>
                            <Box p={3}>
                    ...
                    {/* PIN Settings & System */}
                    <Grid size={{ xs: 12, md: 6 }}>
                        <AppCard title="Security & System" sx={{ bgcolor: '#FFFFFF', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
                            <Box p={3}>
                    ...
                    <Grid size={{ xs: 12, md: 6 }}>
                        <AppCard title="Appearance" gradient="linear-gradient(135deg, #667eea 0%, #764ba2 100%)" sx={{ bgcolor: '#FFFFFF' }}>
                            <Box p={3}>
                    ...
                    <Grid size={{ xs: 12, md: 6 }}>
                        <AppCard title={`Sync: ${selectedUser.name}`} gradient="linear-gradient(135deg, #60A5FA 0%, #8B5CF6 100%)" sx={{ bgcolor: '#FFFFFF' }}>
                            <Box p={3}>
                    ...
                    {/* Screensaver Section */}
                    <Grid size={{ xs: 12, md: 6 }}>
                        <AppCard title={`Photos: ${selectedUser.name}`} gradient="linear-gradient(135deg, #f093fb 0%, #f5576c 100%)" sx={{ bgcolor: '#FFFFFF' }}>
                            <Box p={3}>
                                {isConnected ? (
                    ...
                    {/* Collage Frames */}
                    <Grid size={{ xs: 12, md: 6 }}>
                        <AppCard title="Collage Frames" gradient="linear-gradient(135deg, #a8edea 0%, #fed6e3 100%)" sx={{ bgcolor: '#FFFFFF' }}>
                            <Box p={3}>
                                <CollageFrameManager />
                            </Box>
                        </AppCard>
                    ...
                    <Grid size={{ xs: 12, md: 6 }}>
                        <AppCard title="Gamification" gradient="linear-gradient(135deg, #f093fb 0%, #f5576c 100%)" sx={{ bgcolor: '#FFFFFF' }}>
                            <Box p={3}>
                                <Typography variant="body2" color="text.secondary" mb={2}>
